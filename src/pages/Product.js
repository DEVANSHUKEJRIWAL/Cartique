...
import { add, remove } from '../redux/Slices/cartSlice'; // Update this import with the correct path
                    ...
                    <div className="flex justify-between items-center mt-20">
                        ...
                        <div className='flex'>
                            {cart.some((p) => p.id === product.id) ? (
                                <>
                                    <button
                                        className="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded mr-2"
